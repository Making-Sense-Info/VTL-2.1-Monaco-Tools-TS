...
export const getSuggestionsFromRange = (range: IRange): languages.CompletionItem[] => {
    return [
        {
            label: "eval",
            kind: FUNCTION,
        ...
        },
        {
            ...
            range: range,
            documentation: {
                value: "Conditional operator  \n\n **Syntax** \n\n    case when condition then thenOperand  {when condition then thenOperand}* else elseOperand "
            }
        },
        {
            label: "then",
        ...
        },
        {
            ...
            range: range,
            documentation: {
                value: "The operator **dayofmonth** returns the ordinal day within the month (between 1 and 31).   \n\n **Syntax** \n\n    dayofmonth(op) "
            }
        },
        {
            label: "dayofyear",
            ...
            range: range,
            documentation: {
                value: "The operator **dayofyear** returns the ordinal day within the year (between 1 and 366).   \n\n **Syntax** \n\n    dayofyear(op) "
            }
        },
        {
            label: "daytoyear",
            kind: FUNCTION,
            insertText: "daytoyear",
            range: range,
            documentation: {
                value: "The operator **daytoyear** returns a duration having the following mask:  \\PY\\YDDD\\D.   \n\n **Syntax** \n\n    daytoyear(op) "
            }
        },
        {
            label: "daytomonth",
            kind: FUNCTION,
            insertText: "daytomonth",
            range: range,
            documentation: {
                value: "The operator **daytomonth** returns a duration having the following mask:  \\PM\\MDD\\D.   \n\n **Syntax** \n\n    daytomonth() "
            }
        },
        {
            label: "yeartoday",
            kind: FUNCTION,
            insertText: "yeartoday",
            range: range,
            documentation: {
                value: "The operator **yeartoday** takes as input a duration having the following mask:  `\\PY\\YDDD\\D`;  \n\nreturns the corresponding number of years and days (according to ISO 8601 Y = 365D)   \n\n **Syntax** \n\n    yeartoday(op) "
            }
        },
        {
            label: "monthtoday",
            kind: FUNCTION,
            insertText: "monthtoday",
            range: range,
            documentation: {
                value: "The operator **monthtoday** takes as input a duration having the following mask: `\\PM\\MDD\\D`;  \n\nreturns the corresponding number of months and days;  according to ISO 8601 M = 30D).   \n\n **Syntax** \n\n    monthtoday(op) "
            }
        },
        {
            label: "on",
        ...
        },
        {
            ...
            range: range,
            documentation: {
                value: "The operator generates a sequence number >= 0 and <1, based on seed parameter and returns the number value corresponding to index.  \n\n **Syntax** \n\n    random(seed, index) "
            }
        },
        {
            label: "trunc",
